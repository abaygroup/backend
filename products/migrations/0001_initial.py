# Generated by Django 3.2 on 2021-07-18 07:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('videohosting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.videohosting', verbose_name='Ссылки')),
            ],
            options={
                'verbose_name': 'Ссылка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='products.category', verbose_name='Категория')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product', verbose_name='Продукт')),
            ],
            options={
